# Generated by Django 2.2.2 on 2019-07-23 11:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history', models.TextField(blank=True, default='No History', max_length=200, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Employee',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('emp_id', models.CharField(default='emp393', max_length=70, unique=True)),
                ...
                ('joined', models.DateTimeField(default=datetime.datetime(2019, 7, 23, 11, 39, 57, 197083, tzinfo=utc))),
